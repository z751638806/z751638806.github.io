...
PATCHES = {
    "index.html": [
        ...
        # 一键救砖面板（免上传）：勾选覆盖声明 → 内置三件套直接刷写
        ("引导程序已内置，无需额外提供。\n        </p>",
         "引导程序已内置，无需额外提供。\n        </p>\n        <div class=\"alert alert-info\" style=\"margin:2px 0 10px;\">\n          <strong>⚡ 一键救砖（免上传）</strong>\n          <p class=\"small dim\" style=\"margin:4px 0;\">自动使用内置的官方引导 + 出厂应用镜像，把设备恢复到出厂可测试状态，全程无需上传任何文件。</p>\n          <label class=\"advanced-row\" style=\"margin:8px 0;\">\n            <input type=\"checkbox\" id=\"oneclick-agree\">\n            我已了解：刷写将<b>擦除并覆盖</b>板上现有固件数据（不可撤销）\n          </label>\n          <button id=\"btn-oneclick-rescue\" class=\"btn btn-primary\" type=\"button\">一键救砖恢复</button>\n        </div>", 1),
