...
/* ---- 顶栏 ---- */
.topbar { background: #0b0e12; border-bottom: 1px solid #1c232c; padding: 10px 20px; }
...
h2::after { content: ""; flex: 1; height: 1px; background: #262e39; }
...
/* ---- 页脚 ---- */
.footer { max-width: none; background: #0b0e12; color: var(--text-dim); border-top: 1px solid #1c232c; margin-top: 40px; padding: 26px 20px 34px; text-align: center; }
